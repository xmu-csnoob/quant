...
# from src.data.fetchers.tushare import TushareDataFetcher  # 需要 tushare
from src.data.fetchers.base import Exchange
from src.data.processors.normalizer import normalize_from_source
...
def test_data_views():
    ...
    # 获取所有可用视图
    from src.data.database import PREDEFINED_VIEWS
